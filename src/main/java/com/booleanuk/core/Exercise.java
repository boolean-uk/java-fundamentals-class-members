...
public class Exercise extends ExerciseBase {
    ...
    // If Car were a class, some members of it might be colour, transmission, make
    // and model.
    // The structure of defining a member is <visibility> <data type> <name> =
    // <value>
    // The below member has a visibility of public, meaning other classes can see
    ...
    // 4. Change the value below so that the tests pass. Check the README.md file
    // for instructions on
